...
**Examples:**
- "তিনি তিনটি জিনিস বলোেছেন: সত্য, সততা, সাহস।"
- "একটাই কথা: পড়াশোনা করো।"

Bengali কোলon is fine. No Bengali-specific rule.
...
If the user used সেমিকোলon in a casual post, suggest replacing with দাড়ি or কমা.
...
**In Bengali-script text:**
- "তিনি বললেন, 'আমি আসব।'"
- Or: "তিনি বললেন, "আমি আসব।""
...
Same as English. Em dash is rare in standard Bengali prose. Prefer কমা or দাড়ি.

**If the user used em dash in casual writing:**
- Suggest replacing with কমা + কমা, or দাড়ি, depending on the rhythm.

**Do not silently remove.** Flag in CHANGES as punctuation.
